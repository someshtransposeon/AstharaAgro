                         ...
                         return (
                              <DataTable.Row>
                                ...
                                {/* <DataTable.Cell  numeric>
                                    ...
                                    <Menu.Item title="Approve" onPress={()=>StatusChange("Approve", pickupAssignmentConfirm._id, index)}/>
                                    <Menu.Item title="Reject" onPress={()=>StatusChange("Reject", pickupAssignmentConfirm._id, index)}/>
                                    <Menu.Item title="Pending" onPress={()=>StatusChange("Pending",  pickupAssignmentConfirm._id, index)}/>
                                    ...
                                    <Menu.Item title="Cancel" onPress={()=>StatusChange("Cancel",  pickupAssignmentConfirm._id, index)}/>
