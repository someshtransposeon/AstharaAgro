...
import { faPlusCircle,faMinusCircle, faSearch, faTimes, faEdit } from '@fortawesome/free-solid-svg-icons';
...
export default function Edit_Accepted_Delivery(props,{route}) {
    ...
    function submitForm() {
        fetch(`http://${host}:5000/update_delivery_by_customer/${deliveryId}`, {
            method: 'PUT',
            headers: {
        ...
        <Provider theme={theme}>
            ...
            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                <Card style={styles.card}>
                    <Card.Title title="Edit Delivery for Customer"/>
                    <Card.Content>
