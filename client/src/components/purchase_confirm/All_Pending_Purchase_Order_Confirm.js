                    ...
                    allPurchaseOrderConfirm.map((purchaseOrderConfirm,index)=>{
                         ...
                         return (
                              <DataTable.Row>
                                ...
                                <DataTable.Cell numeric> 
                                    {Platform.OS=='android' ?
                                        <Button mode="contained" style={{width: '100%'}} icon={() => <FontAwesomeIcon icon={ faEye } />} onPress={() => {navigation.navigate('Edit_Purchase_Order_Confirm', {purchaseId: purchaseOrderConfirm._id})}}>Details</Button>
                                        :
                                        <Button mode="contained" style={{width: '100%'}} icon={() => <FontAwesomeIcon icon={ faEye } />} ><Link to={"/Edit_Purchase_Order_Confirm/"+purchaseOrderConfirm._id}>Details</Link></Button>
                                    }
                                </DataTable.Cell>
                             </DataTable.Row>
                        )
