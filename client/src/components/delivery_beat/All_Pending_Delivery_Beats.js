...
export default function All_Pending_Delivery_Beats({ navigation }) {
    ...
    useEffect(() => {
        ...
        fetch(`http://${host}:5000/retrive_all_pending_delivery_beats`, {
            method: 'GET'
        })
        .then(res => res.json())
        ...
        <ScrollView>
            <View style={styles.view}>
             <DataTable style={styles.datatable}>
               <Title>All Pending Delivery beats</Title>
               <Searchbar
